...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    EventDetails: Schema.Attribute.Component<'events.event-details', true>;
    eventImage: Schema.Attribute.Media<'images' | 'files'>;
...
export interface ApiFooterPageFooterPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    buttonLinks: Schema.Attribute.Component<'buttons.button-link-row', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    campus: Schema.Attribute.Component<'campuses.campuses', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPetraHomePagePetraHomePage
  extends Struct.CollectionTypeSchema {
  collectionName: 'petra_home_pages';
  info: {
    description: '';
    displayName: 'Petra Home Page';
    pluralName: 'petra-home-pages';
    singularName: 'petra-home-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      [
        'blocks.home-about-us',
        'blocks.sermon',
        'blocks.campus-home-page',
        'blocks.petra-images',
        'blocks.get-involved',
      ]
    >;
    button: Schema.Attribute.Component<'buttons.button-link', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Description: Schema.Attribute.Text;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::petra-home-page.petra-home-page': ApiPetraHomePagePetraHomePage;
